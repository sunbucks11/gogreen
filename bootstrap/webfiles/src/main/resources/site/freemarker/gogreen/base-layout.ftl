...
<title>Celebrate Express- Home</title>
<meta charset="utf-8">
...
<link rel="shortcut icon" href="<@hst.webfile path="/images/logo/favicon.ico"/>" type="image/x-icon" />
            ...
            <div class="col-sm-7 langnav">
              <nav>
                <ul class="" id="language">
                  ...
                  <li class="active"><i class="fa fa-ellipsis-h"></i> <span>United Kingdom</span>
                    <ul>
        ...
        <div class="container">
          ...
          <div class="row header">
           ...
           <!--  <a href="index.html"><img src="<@hst.webfile path="/images/gogreenlogo2.png"/>" alt="" height="107" /></a> -->
              <a href="index.html"><img src="<@hst.webfile path="/images/logo/logo-1.jpg"/>" alt="" height="107" /></a>
            </div>
            <!-- //Logo// -->
