...
<head>
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/components/hippo-theme/dist/css/main.css?v=2.1.1"/>
  <link rel="stylesheet" href="${pageContext.request.contextPath}/components/angular-ui-tree/dist/angular-ui-tree.min.css?v=2.1.1"/>
  <script type="application/javascript">
    window.SERVER_URL = '<%=request.getServerName()+':'+request.getServerPort()%>';
  </script>
  <script src="${pageContext.request.contextPath}/components/jquery/dist/jquery.js?v=2.1.1"></script>
  <script src="${pageContext.request.contextPath}/components/angular/angular.js?v=2.1.1"></script>
  <script src="${pageContext.request.contextPath}/components/chosen/chosen.jquery.js?v=2.1.1"></script>
  <script src="${pageContext.request.contextPath}/components/angular-chosen-localytics/chosen.js?v=2.1.1"></script>
  <script src="${pageContext.request.contextPath}/components/angular-bootstrap/ui-bootstrap-tpls.js?v=2.1.1"></script>
  <script src="${pageContext.request.contextPath}/components/angular-ui-router/release/angular-ui-router.js?v=2.1.1"></script>
  <script src="${pageContext.request.contextPath}/components/angular-sanitize/angular-sanitize.min.js?v=2.1.1"></script>

  <%-- HIPPO THEME DEPS --%>
  <script src="${pageContext.request.contextPath}/components/angular-aria/angular-aria.min.js?v=2.1.1"></script>
  <script src="${pageContext.request.contextPath}/js/lib/angular-ui-tree.js?v=2.1.1"></script>
  <script src="${pageContext.request.contextPath}/components/google-code-prettify/src/prettify.js?v=2.1.1"></script>
  <script src="${pageContext.request.contextPath}/components/hippo-theme/dist/js/main.js?v=2.1.1"></script>

  <%-- ESSENTIALS --%>
  <script src="${pageContext.request.contextPath}/js/Essentials.js?v=2.1.1"></script>
  <script src="${pageContext.request.contextPath}/js/app.js?v=2.1.1"></script>
  <script src="${pageContext.request.contextPath}/js/routes.js?v=2.1.1"></script>
  <script src="${pageContext.request.contextPath}/js/directives.js?v=2.1.1"></script>
  <script src="${pageContext.request.contextPath}/js/controllers.js?v=2.1.1"></script>

  <link rel="icon" href="${pageContext.request.contextPath}/images/favicon.ico" type="image/x-icon"/>
  <link rel="shortcut icon" href="${pageContext.request.contextPath}/images/favicon.ico" type="image/x-icon"/>
</head>
<body id="container"  ng-cloak>
<div class="hidden" ng-include="'${pageContext.request.contextPath}/components/hippo-theme/dist/images/hippo-icon-sprite.svg?v=2.1.1'"></div>
